...
<img src= "CharacterCreator-Server/asset/userSignup.PNG" width = 80%>
...
#### 4. /chara/ -GET-Gets all Characters for an individual user.
<img src= "CharacterCreator-Server/asset/allCharacters.png" width = 80%>

#### 6. /chara/:id -PUT-Allows individual Character to be updated by an ID.
<img src= "CharacterCreator-Server/asset/characterUpdate.png" width = 80%>

#### 7. /chara/:id -DELETE-Allows individual Character to be deleted by an ID.
